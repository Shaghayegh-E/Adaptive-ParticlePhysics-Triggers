...
def V1(bht, sht1, sht2, bas, sas1, sas2):
    ...
    return log_Cost, r_b, r1_s, r2_s, HT, AS
...
def local_V1(bht, sht1, sht2, bas, sas1, sas2, bnjets, snjets1, snjets2, ht_value, as_value, ht_window=20, as_window=20, num_points=10):
...
def local_V2(bht, sht1, sht2, bas, sas1, sas2, bnjets, snjets1, snjets2, ht_value, as_value, ht_window=20, as_window=20, num_points=10):
...
def local_V3(bht, sht1, sht2, bas, sas1, sas2, bnjets, snjets1, snjets2, ht_value, as_value, ht_window=20, as_window=20, num_points=10):
